...
Facade deviations are NOT layer merges: (B-1) **CORRECTED 2026-07-13**：二进制与本地现均为 EmoteObject `vector<ttstr>` 资源路径；旧 “variant pointer vector” 结论被 `0x52FDD4→0x67DBAC` producer/consumer 证伪。(B-2) D3DEmotePlayer hairScale/partsScale 仍读 engine shadow，而二进制读 +1184/+1192。
