...
- LIVE _preparedRenderItems left UNTOUCHED (it's the binary's per-draw temp vector, sub_6C2334, distinct buffer). Fixed Player.h:1379 comment to point dead +936 at new member.
