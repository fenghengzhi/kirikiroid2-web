...
//
// @exports: _run_local_transform,_get_affine_in_ptr,_get_affine_out_ptr,_run_local_transform_direct
...
double run_local_transform_direct(
    ...
    return output_index >= 0 && output_index < 6
        ? a[static_cast<size_t>(output_index)]
        : 0.0;
}
