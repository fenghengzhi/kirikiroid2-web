...
set(EMSCRIPTEN_PATCHES "")
if(VCPKG_TARGET_IS_EMSCRIPTEN)
    # wasm has no DNS/socket/spawn/inotify: disable gio/girepository/fuzzing subdirs, demote wasm32
    # gsize/size_t pointer-type mismatches to warnings, and skip gtester/gobject-query tool exes.
    # libgdiplus only needs GLib core + GObject static libs.
    set(EMSCRIPTEN_PATCHES emscripten-no-gio.patch)
endif()
...
if(VCPKG_TARGET_IS_EMSCRIPTEN)
    list(REMOVE_ITEM GLIB_SCRIPTS gdbus-codegen)  # gio tool, absent when gio subdir is disabled
endif()
...
elseif(VCPKG_TARGET_IS_EMSCRIPTEN)
    set(GLIB_TOOLS "")  # all entries are gio/girepository tools or the gated-off gtester/gobject-query
endif()
if(GLIB_TOOLS)
...
if(VCPKG_TARGET_IS_EMSCRIPTEN)
    list(REMOVE_ITEM pc_replace_intl_path gio)
endif()
...
if(EXISTS "${_file}")  # gdbus-codegen is a gio tool; absent on wasm where gio is disabled
