...
| J-4 | P1-3 RESOLVED | 6→4 map mapping | 4 inline HM = +264/+320/+1184/+1240 | _evalCascadeMap=HM1, _evalResultValues=HM2, _perNodeLayerStateMap=HM3, _dispatchAliasMap=HM4(wrong) | `_timelines` 已删除；其余 local maps 仍不对应这 4 个 binary HM。See J-5. |
| J-5 | P2 | Invented maps | binary has NO motionsByKey/timeline/layerId/selector HMs at these offsets | 2026-07-19：Player timeline map/vector 已删除；其余发明 map 另案迁移 | NOT part of the 4-HM contract. |
