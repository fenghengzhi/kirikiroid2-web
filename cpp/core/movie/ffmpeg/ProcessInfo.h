...
protected:
    ...
    // player video info
    // These scalar fields deliberately have no default member initializers.
    // The reference constructor builds only the strings, mutexes and
    // CRenderInfo; Reset*/Set* establish the scalar values later.
